...
C %W%    %G%
C
C Selected subset of LAPACK routine.  At the moment, just enough for
C single and double precision SVDs.
C
...
* Fullsource for module SGESVD from package LAPACK.
* Retrieved from NETLIB on Tue Feb  7 01:35:10 1995.
* ======================================================================
...
* Retrieved from NETLIB on Tue Feb  7 01:42:38 1995.
* ======================================================================
