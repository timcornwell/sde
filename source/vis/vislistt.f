...
C++
C @(#)vislistt.f	1.2    6/5/93
C
      SUBROUTINE VISLISTT (HANDLE, NAME, SUB, NLIST, DOALL)
C
CD List visibility data  in order of time
C
...
C
      CALL VISLISTP (HANDLE, MEMX(VSADD), MEMR(BADD), MEMR(TADD), 
