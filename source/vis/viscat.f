...
C++
C @(#)viscat.f	1.3    11/27/90
C
       SUBROUTINE VISCAT (NAME1, NAME2, NAME3, SUB, STOKES)
C
CD Concatenate visibility data
C
C
...
C				e.g. IQUV
C Audit trail:
C	Changed order of arguments and allowed looping over Stokes
...
C
         CALL ARRCAT (STRM2(NSUBS1, 'VIS'), STRM2(NSUBS2, 'VIS'),
     $      STRM2(NSUBS3, 'VIS'))
