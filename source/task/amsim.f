...
C
     ...
     1   DBLE(TIME), INTTIME, AUTOC, AUTOW, 'IVis')
...
C
     ...
     1                             CRPIX, CDELT, CROTA)
      ...
      NPP = MAX (NINT (HDEL*3600./INTTIME ), 1)
C
...
C
     ...
     $         ELMIN, DBLE(TIME), INTTIME, AUTOC, AUTOW, VIS)
            TIME = TIME + NPP * INTTIME / 86400.
            HMIN = HMIN + HDEL
            HMAX = HMAX + HDEL
