...
C++
C @(#)pixdlis1.f	1.3	 7/18/97
C
      SUBROUTINE PIXDLIS1 (ARRAY, N, ISKIP, WHAT)
C
C Lists a double precision array via MSGPUT
C
C	ARRAY	DBL	input	a real array.  big deal
...
C	Changed E output format to G
C-----------------------------------------------------------------------
C
#include		"stdinc.h"
C
