...
C++
C @(#)pixairyv.f	1.3    11/7/90
C
      SUBROUTINE PIXAIRYV (NAIRY, AIRYARR, RADMAX)
C
CD Make the VOLTAGE pattern in a work array
C
C
...
C	Altered PIXAIRY to do VOLTAGE pattern rather than BEAM
