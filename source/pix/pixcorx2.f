...
C++
C @(#)pixcorx2.f	1.3    11/7/90
C
      SUBROUTINE PIXCORX2 (IN, NX, NY, CF, CFLEN, MODE, OUT, CENX,
     $   CENY)
C
CD Correct array for a given function
C
C	IN	CMPLX(*)	input	Array to be corrected
...
C	OUT	CMPLX(*)	output	Corrected array
