...
C
      ...
      REAL		TIMIN(NIN), DATIN(*), WGTIN(NIN),
     $   		TIMOUT(NOUT), DATOUT(*), WGTOUT(NOUT), TINT
C
      CHARACTER*(*)	ROUTINE
      PARAMETER		(ROUTINE = 'PIXRBXCR')
C
      REAL		TINTSM, TREF, TMIN, TMAX, ACC, SUMWT
