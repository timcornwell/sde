...
C++
C @(#)pixdscpy.f	1.1    10/29/91
C
      SUBROUTINE PIXDSCPY (IN, WT, OUT, NIN, NOUT)
C
CD Copy an array conditionally on a weight
C
C	IN	DOUBLE	input	Input array
C       WT      REAL    input   Weight array
C	OUT	DOUBLE	output	Output array
