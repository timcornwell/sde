...
C++
C @(#)pixiinse.f	1.2 8/14/92
C
      SUBROUTINE PIXIINSE (A, B, AN1, AN2, AN3, AN4, AN5, AN6, AN7,
     1   BN1, BN2, BN3, BN4, BN5, BN6, BN7, BLC, TRC, STEP)
C
CD Add array A into array B
C
C	A	INT	input	Input array
C	B	INT	output	Output array
...
C
      ...
      INTEGER		A(AN1,AN2,AN3,AN4,AN5, AN6, AN7)
      INTEGER		B(BN1,BN2,BN3,BN4,BN5, BN6, BN7)
C
      CHARACTER*(*)	ROUTINE
      PARAMETER		(ROUTINE = 'PIXIINSE')
C
